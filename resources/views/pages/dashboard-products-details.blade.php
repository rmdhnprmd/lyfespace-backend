                  ...
                  <div class="col-md-12">
                    <div class="form-group mb-3">
                      ...
                      <select name="categories_id" class="form-select">
                        <option value="{{ $product->categories_id }}">Current ({{ $product->category->name }})</option>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12 mt-2">
                  <form action="{{ route('dashboard-product-gallery-upload') }}" method="POST" enctype="multipart/form-data" class="d-grid">
                    @csrf
