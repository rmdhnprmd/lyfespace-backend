...
Route::group(['midlleware' => ['auth']], function(){
      ...
      Route::delete('/dashboard/products-delete/{id}', [App\Http\Controllers\DashboardProductController::class, 'destroy'])
      ...
      Route::get('/dashboard/transactions/buy/{id}', [App\Http\Controllers\DashboardTransactionController::class, 'detailsBuy'])
